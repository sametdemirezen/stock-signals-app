 ...
 * S&P 500 ticker list.
 *
 * Static snapshot — ~500 large-cap US equities. Updated roughly
 * quarterly by S&P. We embed this rather than fetching at runtime
 * because:
 *   - Internet calls add latency and failure modes
 *   - The list barely changes (~20 swaps/year)
 *   - We control exactly what gets scanned
 *
 * To refresh: pull from
 *   https://en.wikipedia.org/wiki/List_of_S%26P_500_companies
 * or your data provider, then paste the symbols here.
 */
export const SP500_TICKERS: readonly string[] = [
  ...
  'BAC', 'BALL', 'BAX', 'BBY', 'BDX', 'BEN', 'BG', 'BIIB', 'BIO', 'BK',
  ...
  'CPT', 'CRL', 'CRM', 'CSCO', 'CSGP', 'CSX', 'CTAS', 'CTRA', 'CTSH', 'CTVA',
  ...
  'URI', 'USB', 'V', 'VICI', 'VLO', 'VMC', 'VRSK', 'VRSN', 'VRTX', 'VST',
